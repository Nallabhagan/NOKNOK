...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="css/noknok.css">
    <!-- Google Fonts -->
              ...
              <nav id="navigation">
                <ul id="responsive">
                  ...
                  <li>
                    ...
                    <ul class="dropdown-nav">
                      <li>
                        <a href="#"><i class="icon-feather-chevrons-right"></i> Browse Jobs</a>
                        <ul class="dropdown-nav">
                      ...
                      <li>
                        <a href="#"><i class="icon-feather-chevrons-right"></i> Freelancer Tasks</a>
                        <ul class="dropdown-nav">
                  ...
                  <li>
                    <a href="#" class="current">User Panel</a>
                    <ul class="dropdown-nav">
                      ...
                      <li>
                        <a href="dashboard-manage-tasks.html"><i class="icon-feather-chevrons-right"></i> Freelancer Tasks</a>
                        <ul class="dropdown-nav">
                      ...
                      <li class="active"><a href="dashboard-my-profile.html"><i class="icon-feather-chevrons-right"></i> My Profile</a></li>
                    </ul>
                  </li>
                  <li>
                    <a href="#">Pages</a>
              ...
              <div class="utf-dashboard-nav">
                <div class="utf-dashboard-nav-inner">
                  ...
                  <ul>
                    ...
                    <li><a href="dashboard-bookmarks.html"><i class="icon-feather-heart"></i> Bookmarks Jobs</a></li>
                    <li>
                      <a href="#"><i class="icon-line-awesome-file-text"></i> Freelancer Tasks</a>
                      <ul class="dropdown-nav">
                        <li><a href="dashboard-freelancer-manage-tasks-list.html"><i class="icon-feather-chevrons-right"></i> Freelancer Manage Tasks</a></li>
                        <li><a href="dashboard-manage-bidders-list.html"><i class="icon-feather-chevrons-right"></i> Freelancer Manage Bidders</a></li>
                        <li><a href="dashboard-freelancer-active-bids.html"><i class="icon-feather-chevrons-right"></i> Freelancer Active Bids</a></li>
                    ...
                    <li class="active"><a href="dashboard-my-profile.html"><i class="icon-feather-user"></i> My Profile</a></li>
                    <li><a href="index-1.html"><i class="icon-material-outline-power-settings-new"></i> Logout</a></li>
                  </ul>
                </div>
              </div>
                    ...
                    <div class="row">
                      <div class="col-xl-12 col-md-6 col-sm-6">
                        <div class="utf-submit-field">
                          ...
                          <input type="password" class="utf-with-border" title="Current Password" data-tippy-placement="top" placeholder="********">
                        </div>
                      </div>
                      <div class="col-xl-12 col-md-6 col-sm-6">
                        <div class="utf-submit-field">
                          <h5>New Password</h5>
                          <input type="password" class="utf-with-border" title="The password must be at least 8 characters" data-tippy-placement="top" placeholder="********">
                        </div>
                      </div>
                      <div class="col-xl-12 col-md-6 col-sm-6">
                        <div class="utf-submit-field">
