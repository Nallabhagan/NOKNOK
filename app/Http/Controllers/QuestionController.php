...
class QuestionController extends Controller
{
    ...
    public function publish_interview(Request $request) {
        ...
        $id =  Hashids::connection('create_question')->decode($request->interview_id);
        $publish_interview = Question::where(['id' => $id])->update(['status' => 'PUBLISHED','thumbnail_image' => $new_name]);
